...
FACTOR = 4.0 # TODO: After above, change only this to make the assert pass
...
print(abs(monte_carlo_pi() - math.pi))
...
stopping_number = 4 # fix me!
skipped_number = 4 # fix me!
endpoint = 9 # fix me!

print("Testing break versus continue:")
print("break", "outputs:", sep=" ", end=' ')
